...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'restaurant_menuitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('section', self.gf('modelcluster.fields.ParentalKey')(related_name='menu_items', to=orm['restaurant.MenuSection'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('description', self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True)),
            ('pricing', self.gf('django.db.models.fields.CharField')(max_length=254)),
        ))
        db.send_create_signal(u'restaurant', ['MenuItem'])

        # Adding model 'MenuPage'
        db.create_table(u'restaurant_menupage', (
        ...
        db.send_create_signal(u'restaurant', ['MenuPage'])

        # Adding model 'MenuSection'
        db.create_table(u'restaurant_menusection', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True)),
            ('intro', self.gf('wagtail.wagtailcore.fields.RichTextField')()),
        ))
        db.send_create_signal(u'restaurant', ['MenuSection'])


    def backwards(self, orm):
        # Deleting model 'MenuItem'
        db.delete_table(u'restaurant_menuitem')

        # Deleting model 'MenuPage'
        db.delete_table(u'restaurant_menupage')

        # Deleting model 'MenuSection'
        db.delete_table(u'restaurant_menusection')
