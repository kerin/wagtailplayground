...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MenuList'
        db.create_table(u'restaurant_menulist', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True)),
            ('intro', self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True)),
        ))
        db.send_create_signal(u'restaurant', ['MenuList'])


    def backwards(self, orm):
        # Deleting model 'MenuList'
        db.delete_table(u'restaurant_menulist')
