...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MenuItem.featured'
        db.add_column(u'restaurant_menuitem', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MenuItem.featured'
        db.delete_column(u'restaurant_menuitem', 'featured')
