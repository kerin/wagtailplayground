...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Section.intro'
        db.alter_column(u'restaurant_section', 'intro', self.gf('wagtail.wagtailcore.fields.RichTextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Section.intro'
        db.alter_column(u'restaurant_section', 'intro', self.gf('wagtail.wagtailcore.fields.RichTextField')(default=''))
