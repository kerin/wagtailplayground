...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogPost.google_map_url'
        db.add_column(u'restaurant_blogpost', 'google_map_url',
                      self.gf('django.db.models.fields.URLField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogPost.google_map_url'
        db.delete_column(u'restaurant_blogpost', 'google_map_url')
