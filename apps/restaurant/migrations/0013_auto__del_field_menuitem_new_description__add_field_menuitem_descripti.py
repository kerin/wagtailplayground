...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MenuItem.new_description'
        db.delete_column(u'restaurant_menuitem', 'new_description')

        # Adding field 'MenuItem.description'
        db.add_column(u'restaurant_menuitem', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=254, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MenuItem.new_description'
        db.add_column(u'restaurant_menuitem', 'new_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=254, blank=True),
                      keep_default=False)

        # Deleting field 'MenuItem.description'
        db.delete_column(u'restaurant_menuitem', 'description')
    ...
    models = {
        ...
        u'restaurant.blogpost': {
            ...
            'google_map_url': ('django.db.models.fields.URLField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
        ...
        u'restaurant.menuitem': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '254', 'blank': 'True'}),
